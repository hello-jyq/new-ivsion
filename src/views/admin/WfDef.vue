  ...
  <div class="definition">
        ...
        <el-collapse-item name="1">
          ...
          <div class="mode input_box">
            <div class="flex3">
              ...
              <el-input
                v-model="searchParam.params.defId"
                class="input"
                :placeholder="$t('admin.wfDef.processDefinitionId')"
                clearable
              />
            </div>
            <div class="flex3">
              ...
              <el-input
                v-model="searchParam.params.key"
                class="input"
                :placeholder="$t('admin.wfDef.processDefinitionKey')"
                clearable
              />
            </div>
          </div>
    ...
    <div class="content">
      ...
      >
        ...
        <el-table-column align="center" :label="$t('comm.operation')" width="80">
        ...
        <el-table-column prop="id" :label="$t('admin.wfDef.processDefinitionId')" min-width="180">
          <template slot-scope="scope">
        ...
        <!-- <el-table-column
          ...
          label="种类"
        />-->
        <el-table-column prop="name" :label="$t('admin.wfDef.name')" min-width="100" />
        <el-table-column
          prop="key"
        ...
        <el-table-column
          ...
          min-width="100"
        />
        <el-table-column prop="version" :label="$t('admin.wfDef.version')" width="100" />
        <el-table-column prop="deploymentId" :label="$t('admin.wfDef.deploymentId')" width="100" />
      </el-table>
    ...
    >
      <div class="content">
        ...
        <upload
          action="/api/workflow/admin/uploadZip"
          :on-success="handleUploadSuccess"
          :on-error="handleUploadError"
          :multiple="false"
          @finish="uploadOneDialog=false"
        />
      </div>
    </el-dialog>
    <el-dialog
    ...
    <div class="startDialog">
      <el-dialog :title="$t('admin.wfDef.startUp')" :visible.sync="startDialog" width="80%">
        <div class>
        ...
        <div class="table">
          <el-table :data="variableTable" border height="200" style="width: 100%">
            <el-table-column>
              <template slot-scope="scope">
                <el-button
                  size="mini"
    ...
    <el-dialog :title="$t('admin.wfDef.processPhoto') + defId" :visible.sync="defPicDialog">
      <div>
        <el-image id="pic" :src="picUrl" width="100%" fit="contain" />
      </div>
    </el-dialog>
  </div>
</template>
