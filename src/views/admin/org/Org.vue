    ...
    <div class="content">
          ...
          <div class="">
            <div class="input_box">
              <div v-show="true" class="flex2">
                ...
                <div class="input">
                  <el-input v-model="addOrgData.id" :placeholder="$t('admin.org.orgId')" class="input" @blur="validator('orgAddOrgId')" />
                  <span ref="orgAddOrgId" data-roles="required" :data-value="addOrgData.id" class="message" />
                </div>
              </div>
              <div class="flex2">
                <div class="title">
                ...
                <div class="input">
                  <el-input v-model="addOrgData.orgCode" :placeholder="$t('admin.org.orgCode')" class="input" />
                </div>
              </div>
              <div class="flex2">
                <div class="title must">
      ...
      <div class="addUserDilog">
        ...
        >
          <div class="personnel">
            <!-- 基本信息 -->
            <h4>
              {{ $t('comm.essentialInformation') }}<div class="add_row iconfont icon-jia" @click.stop="userChose('addUserData')">
            ...
            <div class="input_box">
              ...
              <div class="flex2">
                ...
                <div class="input">
                  <dict-select v-model="addUserData.authMode" dict-type-id="AuthMode" class="input" @blur="validator('userAuthMod')" />
            ...
            <div class="personnel">
              ...
              <div v-for="(userOrg,index) in addUserData.userOrgs" :key="index">
                ...
                <h4>
                  ...
                  <div class="add_row iconfont icon-jia" @click.stop="orgChoseAndAddOrgRow('addUserData', index)">
                    {{ $t('admin.org.addAffiliation') }}
                  </div>
                </h4>
                <!-- 所属机构 -->
                  ...
                  <div>
                    <div class="input_box">
                      <div class="flex2">
                        ...
                        <div class="input">
                          <el-input v-model="userOrg.orgId" :placeholder="$t('admin.org.orgId')" class="input" />
                        </div>
                      </div>
                      <div class="flex2">
                        <div class="title">
                        ...
                        <div class="input">
                          <el-input v-model="userOrg.orgName" :placeholder="$t('admin.org.orgCode')" class="input" @blur="validator('orgAddOrgCode')" />
                        </div>
                      </div>
                      <div class="flex2">
                        <div class="title">
                      ...
                      <div v-show="false" class="flex2">
                        ...
                        <div class="input">
                          <el-input v-model="userOrg.userId" :placeholder="$t('admin.org.userId')" class="input" />
                        </div>
                      </div>
                    </div>
                    <!-- 机构所属角色-->
                    <div>
                      <el-button size="mini" icon="el-icon-edit" type="primary" style="float: right; padding: 3px 0" @click.stop="roleChose('addUserData', index)">
                        {{ $t('admin.org.addRole') }}
                      </el-button>
                      <div class="table">
                        <el-table
                        ...
                        >
                          <el-table-column :label="$t('comm.operation')" width="70" :style="{textAlign: 'center'}">
                            <template slot-scope="scope">
                              <el-button size="mini" icon="el-icon-delete" type="danger" @click="roleHandleDelete('addUserData', scope.row, index, scope.$index)" />
                            </template>
                          </el-table-column>
      ...
      <div class="orgChoseDilog">
        ...
        >
          ...
          <div class="box">
            <tissue-tree tree-type="department" :valid-year="searchParam.params.validYear" @select="selectP" />
          </div>
          ...
          <div class="personnel">
            ...
            <div v-for="(userOrg,index) in personEdit.userOrgs" :key="index">
              ...
              <h4>
                ...
                <div class="add_row iconfont icon-jia" @click.stop="orgChoseAndAddOrgRow('personEdit', index)">
                  {{ $t('admin.org.addAffiliation') }}
                </div>
              </h4>
              <!-- 所属机构 -->
                  ...
                  <div>
                    ...
                    <div class="table">
                      ...
                      >
                        <el-table-column :label="$t('comm.operation')" width="70" :style="{textAlign: 'center'}">
                          <template slot-scope="scope">
                            <el-button size="mini" icon="el-icon-delete" type="danger" @click="roleHandleDelete('personEdit', scope.row, index, scope.$index)" />
                          </template>
                        </el-table-column>
                        <el-table-column :label="$t('admin.org.roleId')" prop="roleId" />
                        <el-table-column :label="$t('admin.org.roleName')" prop="roleName" />
  ...
  methods: {
    ...
    appendPersonnel(data) {
      ...
      userOrgs.forEach(userOrg => {
        userOrg.userRoles = []
        userOrg.userRoles.push({ roleId: 'ROLE_OPC_SYS_TOOL_AUTH', roleName: '系统功能照会角色' })
      })
