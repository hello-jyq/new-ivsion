      ...
      <div class="">
        <div class="input_box">
          ...
          <div class="flex3">
            ...
            <div class="input">
              <dict-select v-model="quotationSaveForm.quotationType" dict-type-id="QuoType" class="input" />
            </div>
          </div>
          <div class="flex3">
            <div class="title must">
          ...
          <div class="flex3">
            ...
            <div class="input">
              <el-input v-model="pmNode.name" class="input">
                <i slot="suffix" class="iconfont icon-zuzhijiagou" @click.stop="openSelect('pmNode')" />
              </el-input>
          ...
          <div class="flex3">
            ...
            <div class="input">
              <dict-select v-model="quotationSaveForm.transactionsType" dict-type-id="TranType" class="input" />
        ...
        if (res.success) {
          ...
          if (res.messages != null) {
            res.messages.forEach(item => {
              ...
              message = message + filedName + this.$t(item.message, item.arguments)
            })
          }
