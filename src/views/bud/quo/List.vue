  ...
  <div class="apply">
    <div class="search">
      <el-collapse>
        <el-collapse-item name="1">
          ...
          <div class="input_box">
            <div class="flex3">
              <div class="title">{{ $t('bud.quo.identiferNum') }}:</div>
              <el-input
                v-model="searchParam.params.identiferNum"
                class="input"
                :placeholder="$t('bud.quo.identiferNum')"
                clearable
              />
            </div>
            <div class="flex3">
              ...
              <dict-select
                v-model="searchParam.params.quotationType"
                class="input"
              ...
              <span
                ref="ListQuoType"
                data-roles="required"
                :data-value="searchParam.params.quotationType"
                class="message"
              />
            </div>
            <div class="flex3">
              ...
              <el-input
                v-model="searchParam.params.quotationName"
                class="input"
                :placeholder="$t('bud.quo.quotationName')"
                clearable
              />
            </div>
            <div class="flex3">
              ...
              <SelectTree v-model="searchParam.params.pmUser" :props="props" class="input" />
            </div>
            <div class="flex3">
              <div class="title">{{ $t('bud.quo.customerName') }}:</div>
              <el-input
                v-model="searchParam.params.accountId"
                class="input"
                :placeholder="$t('bud.quo.customerName')"
                clearable
              />
            </div>
            <div class="flex3">
              ...
              <el-input
                v-model="searchParam.params.creditRank"
                class="input"
                :placeholder="$t('bud.quo.creditRank')"
                clearable
              />
            </div>
            <div class="flex3">
              ...
              <el-select
                v-model="searchParam.params.transactionsType"
                placeholder="请选择交易种类"
                size="small"
                class="select"
                multiple
              ...
              >
                <el-option
                  v-for="item in transactionsTypeList"
                  :key="item"
                  :label="item"
                  :value="item"
                />
            ...
            <div class="flex3">
              ...
              <el-input
                v-model="searchParam.params.pipelineId"
                class="input"
                :placeholder="$t('bud.quo.email')"
                clearable
              />
            ...
            <div class="flex3">
              ...
              <el-select
                v-model="searchParam.params.orgLevel1"
                placeholder="请选择统括"
                size="small"
                class="select"
                clearable
              >
                <el-option
                  v-for="item in businessDepartmentList"
                  :key="item"
                  :label="item"
                  :value="item"
                />
            ...
            <div class="flex3">
              ...
              <el-input
                v-model="searchParam.params.orgLevel2"
                class="input"
                :placeholder="$t('bud.quo.department')"
                clearable
              />
            </div>
            <div class="flex3">
              <div class="title">{{ $t('bud.quo.payStartDate') }}:</div>
              <el-date-picker
            ...
            <div class="flex3">
              <div class="title">{{ $t('bud.quo.payAcceptDate') }}:</div>
              <el-date-picker
      ...
      <div class="btns">
        <div class="left">
          <el-button
            v-if="hasPermission('quoNewButton')"
            type="primary"
            class="el-icon-circle-plus-outline"
            @click="handleAdd"
          >{{ $t('comm.newlyBuild') }}</el-button>
          <el-button
            v-if="hasPermission('quoDeleteButton')"
            type="danger"
    ...
    <div class="content">
      <el-table ref="table" v-loading="isLoading" :data="dacList" border style="width: 100%">
        ...
        <el-table-column
          v-if="hasPermission('quoDeleteButton') || hasPermission('quoEditButton')"
        ...
        >
          <template slot-scope="scope">
            ...
            />
            <el-button
              v-if="hasPermission('quoEditButton')"
              type="primary"
              size="small"
              icon="el-icon-edit"
        ...
        >
          <template slot-scope="scope">
            <a
              class="link"
              @click.prevent="handleProcessInstClick(scope.row.id)"
        ...
        <el-table-column
          ...
          align="center"
        />
        <el-table-column prop="pipelineId" :label="$t('bud.quo.email')" width="155" align="center" />
      </el-table>
