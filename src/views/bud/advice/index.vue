  ...
  <div :class="theme=='Light'?'apply advice-page apply-light':'apply advice-page'">
    ...
    <div class="advice-content advice-index-content content">
      <ul class="advice-title-box">
        ...
        <li class="advice-title-items">
          <span class="advice-items-text">当前部门</span>
          <span class="advice-items-content">{{ activeName }}</span>
        </li>
      </ul>
            ...
            <div class="swiper-wrapper">
              <div v-for="(item,index) in dataList" :key="index" class="swiper-slide">
                <div class="slide-round-box">
                  <div class="slide-text-box" @click="activeindex == index ? onDetail(item.name):null">
                    <i :class="item.icon" />
                    <p>{{ item.name }}</p>
                  </div>

                  <div class="slide-items-div slide-items-top-left" @click="activeindex == index ? onAdopt('2',item.name):null">
                  ...
                  <div class="slide-items-div slide-items-top-right" @click="activeindex == index ? onAdopt('4',item.name):null">
                    <span class="slide-items-icon">
                  ...
                  <div class="slide-items-div slide-items-bottom-left" @click="activeindex == index ? onAdopt('1',item.name):null">
                    <span class="slide-items-icon">
                  ...
                  <div class="slide-items-div slide-items-bottom-right" @click="activeindex == index ? onAdopt('3',item.name):null">
                    <span class="slide-items-icon">
                      <i class="iconfont icondaiban1" />
                    </span>
                    <div>
...
.home aside.collapse+ .header+ .main .advice-top-box .swiper-big-box .swiper-slide-active {
  margin: 0 119px;
}
...
.swiper-slide-active .slide-round-box {
  ...
  .slide-items-top-left {
    animation: topLeft 1s 0s forwards;
    -webkit-animation: topLeft 1s 0s forwards;
    -moz-animation: topLeft 1s 0s forwards;
  }
  .slide-items-top-right {
    animation: topRight 1s 0s forwards;
    -webkit-animation: topRight 1s 0s forwards;
    -moz-animation: topRight 1s 0s forwards;
  }
  .slide-items-bottom-left {
    animation: bottomLeft 1s 0s forwards;
    -webkit-animation: bottomLeft 1s 0s forwards;
    -moz-animation: bottomLeft 1s 0s forwards;
  }
  .slide-items-bottom-right {
    animation: bottomRight 1s 0s forwards;
    -webkit-animation: bottomRight 1s 0s forwards;
    -moz-animation: bottomRight 1s 0s forwards;
  }
}
...
.apply-light {
  ...
  .advice-top-box {
    ...
    .swiper-slide-active {
      ...
      .slide-items-top-left {
        animation: topLeft-light 1s 0s forwards;
        -webkit-animation: topLeft-light 1s 0s forwards;
        -moz-animation: topLeft-light 1s 0s forwards;
      }
      .slide-items-top-right {
        animation: topRight-light 1s 0s forwards;
        -webkit-animation: topRight-light 1s 0s forwards;
        -moz-animation: topRight-light 1s 0s forwards;
      }
      .slide-items-bottom-left {
        animation: bottomLeft-light 1s 0s forwards;
        -webkit-animation: bottomLeft-light 1s 0s forwards;
        -moz-animation: bottomLeft-light 1s 0s forwards;
      }
      .slide-items-bottom-right {
        animation: bottomRight-light 1s 0s forwards;
        -webkit-animation: bottomRight-light 1s 0s forwards;
        -moz-animation: bottomRight-light 1s 0s forwards;
      }
    }
    .slide-round-box {
...
@-webkit-keyframes topLeft-light {
  from {
    opacity: 0;
    left: 200px;
    top: 200px;
...
@-webkit-keyframes topRight-light {
  from {
    opacity: 0;
    right: 200px;
    top: 200px;
...
@-moz-keyframes bottomLeft-light {
  from {
    opacity: 0;
    left: 200px;
    bottom: 200px;
...
@-webkit-keyframes bottomLeft-light {
  from {
    opacity: 0;
    left: 200px;
    bottom: 200px;
...
@-moz-keyframes bottomRight-light {
  from {
    opacity: 0;
    right: 200px;
    bottom: 200px;
...
@-webkit-keyframes bottomRight-light {
  from {
    opacity: 0;
    right: 200px;
    bottom: 200px;
