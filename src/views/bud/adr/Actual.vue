    ...
    <div class="advice-content content">
      ...
      <div class="table-bg-box search-list-table">
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <div class="advice-watch-btn" @click="handleWatch(scope.$index, scope.row)">
                <!-- 查看图标 -->
        ...
        <div style="display: flex;flex-direction: column;height: 100%;">
          <ul class="advice-title-box">
            <li class="advice-title-items">
              <span class="advice-items-content">禀议编号：{{ detail.number }}</span>
            </li>
            <li class="advice-title-items">
              <span class="advice-items-content">实绩金额：{{ detail.money }}</span>
            </li>
          </ul>
