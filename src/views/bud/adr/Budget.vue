      ...
      <el-scrollbar>
        ...
        <div class="table-bg-box table-span-style  table-advice-span-style marigin-bottom">
          ...
          >
            ...
            <el-table-column prop="total" label="合计" header-align="center" align="right" min-width="102" show-overflow-tooltip>
            ...
            <el-table-column v-if="isShowYear" prop="firstHalfYear" label="上半年" header-align="center" align="right" min-width="100" show-overflow-tooltip />
            <el-table-column v-if="isShowYear" prop="secondHalfYear" min-width="102" header-align="center" align="right" label="下半年" show-overflow-tooltip />
...
export default {
  data() {
    return {
      ...
      tableData: department.budget.datas.data,
  ...
  methods: {
    ...
    selectNode(target) {
      ...
      if (target.children === null) {
        this.tableData = child.budget.datas.data
      } else {
