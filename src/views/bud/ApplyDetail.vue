    ...
    <div class="detail">
      <div class="info">
        <div class="codition_department">
          ...
          <el-input size="small" placeholder="测试课" disabled :value="inputDetail.length && inputDetail[0]" />
        </div>
        <div class="codition_department">
          <div class="title">
            预算科目：
          </div>
          <el-input size="small" placeholder="预算科目" disabled :value="inputDetail.length && inputDetail[1]" />
        </div>
      ...
      <h3>
        预算明细<div class="add_row iconfont icon-jia" @click.stop="addDetailRows">
          新增一行
        </div>
      </h3>
