<template>
  <div class="change">
    ...
    <div class="content">
      ...
      <div class="out">
        <h4>
          调出（单位：元）<div class="add_row iconfont icon-jia" @click.stop="addTableRows('outTableData')">
            新增一行
          </div>
        </h4>
        <div class="table">
          <el-table
            ...
            style="width: 100%"
          >
            <el-table-column :label="$t('comm.operation')" width="65" :style="{textAlign: 'center'}">
              <template slot-scope="scope">
                <el-button size="mini" icon="el-icon-delete" type="danger" @click="handleDelete('outTableData', scope.row, scope.$index)" />
              </template>
            </el-table-column>
            <!-- <el-table-column
              prop="department"
              ...
              <template slot-scope="scope">
                <div class="box">
                  <div v-if="department === '企划部'" class="searchBox">
                    ...
                    <i title="点击检索" class="iconfont icon-search search" @click="searchDepartment('outTableData', scope.$index)" />
                  </div>
      ...
      <div class="in">
        <h4>
          调入（单位：元）
          <div class="add_row iconfont icon-jia" @click.stop="addTableRows('inTableData')">
            新增一行
          </div>
        </h4>
        <div class="table">
          ...
          >
            ...
            <el-table-column :label="$t('comm.operation')" width="65" :style="{textAlign: 'center'}">
              <template slot-scope="scope">
                <el-button size="mini" icon="el-icon-delete" type="danger" @click="handleDelete('inTableData', scope.row, scope.$index)" />
              </template>
            </el-table-column>
            <el-table-column label="预算部门" width="180">
              <template slot-scope="scope">
                <div class="box">
                  <div v-if="department === '企划部'" class="searchBox">
                    <el-input v-model="scope.row.department" placeholder="请输入预算部门" class="input" />
                    <i title="点击检索" class="iconfont icon-search search" @click="searchDepartment('inTableData', scope.$index)" />
                  </div>
                  <div v-else class="selectBox">
                    <el-select v-model="scope.row.department" placeholder="请选择">
                      <el-option
    ...
    <department-dialog :ids="ids" :is-show="departmentDialogShow" @change="setDepartment" @close="close" />
  </div>
</template>
<script>
  ...
  watch: {
    department(newValue, oldValue) {
      ...
      if (newValue === oldValue) {
        ...
        this.$confirm('切换部门将重置表格数据, 是否继续?', this.$t('comm.tips'), {
