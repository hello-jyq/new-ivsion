    ...
    <div style="display: flex;flex-direction: column;height: 100%;">
      <div class="middle-box">
        <div class="dialog-search-box middle-input">
          <el-form ref="searchForm" :model="form" label-width="80px" label-position="left">
            ...
            <el-row type="flex" justify="space-between">
              <el-col :span="24">
                <el-form-item label="报价种类" prop="quotationType" class="checkout-height-box" style=" white-space:nowrap;">
            ...
            <el-row type="flex" justify="space-between">
              ...
              <el-col :span="7">
                <el-form-item label="报价金额" prop="quotationMoney">
                  <el-input v-model="form.quotationMoney" type="number" class="align-right"  />
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-form-item style="margin-bottom:0 !important">
              <ul class="operation-box dialog-btn-box end-content-flex mbtn">
      ...
      <div class="footer-box">
        <div class="dialog-table-box">
          <el-table ref="table" v-loading="isLoading" class="scroll-table-box" :data="dacList" height="100%" @header-dragend="headerDragend" stripe border @selection-change="handleSelectionChange">
