    ...
    <div class="search">
      <el-collapse v-model="activeNames">
        <el-collapse-item name="1">
          ...
          <div class="input_box">
            <div class="flex3">
              <div class="title">{{ $t('workflow.processId') }}</div>
              <el-input
                v-model="searchParam.params.procInstId"
                class="input"
                :placeholder="$t('workflow.processId')"
                clearable
              />
            </div>
            <div class="flex3">
              ...
              <el-input
                v-model="searchParam.params.procDefName"
                class="input"
                :placeholder="$t('workflow.processDefinitionName')"
                clearable
              />
            </div>
            <div class="flex3">
              ...
              <el-input
                v-model="searchParam.params.procInstName"
                class="input"
